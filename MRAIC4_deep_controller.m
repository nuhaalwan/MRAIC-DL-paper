...
%Offline plant identification and inverse identification
...
% Plant:
 ...
 if k>nn*0.6
    c(k)=vvv+c(k-1)*c(k-2)/(1+4*(c(k-1))^3);
     else
        if k==1
            c(k)=vvv;
            %c(k)=0;
...
for hh=1:s
   ...
   % d(k)=u(k);
    ...
    dWWW5=alpha*delta*yy4';
    WWW5=WWW5+dWWW5;
    
    dWWW4=alpha*delta4*yy3';
    WWW4=WWW4+dWWW4;
    
    dWWW3=alpha*delta3*yy2';
    WWW3=WWW3+dWWW3;
    
    dWWW2=alpha*delta2*yy1';
    WWW2=WWW2+dWWW2;
